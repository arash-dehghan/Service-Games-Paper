...
def CRExpList(enoughtowin,cantwinmorethan):
    ...
    while keeprunning == True:
        ...
        if total == 0:
            ...
            for i in bwinslist:
                mylist.append(i)
            print(mylist)
            CRExpEquation(enoughtowin,cantwinmorethan)
        else:
            CRExpList(enoughtowin,cantwinmorethan)

def CRExpEquation(enoughtowin,cantwinmorethan):
    global mylist
    equation = ''
    for i in mylist:
    ...
    print("Here is the simplified equation for calculating the expected length of a {}-Game set under CR Rules with Can't Win More Than {}:".format(2*enoughtowin-1,cantwinmorethan))
    print(factor(equation))
    #SRMakeValues(equation,enoughtowin,cantwinmorethan)

def CRMakeValues(equation,enoughtowin,cantwinmorethan):
    global Values
    valueslist=[]
    ...
    CRMakeExcel(valueslist,enoughtowin,cantwinmorethan)
def CRMakeExcel(valueslist,enoughtowin,cantwinmorethan):
    global Values
    wb = xw.Book()
