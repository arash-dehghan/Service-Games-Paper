...
def SRaExpList(enoughtowin,cantwinmorethan):
    ...
    while keeprunning == True:
        ...
        if total == 0:
            ...
            for i in bwinslist:
                mylist.append(i)
            print(mylist)
            SRaExpEquation(enoughtowin,cantwinmorethan)
        else:
            SRaExpList(enoughtowin,cantwinmorethan)

def SRaExpEquation(enoughtowin,cantwinmorethan):
    global mylist
    equation = ''
    for i in mylist:
    ...
    print("Here is the simplified equation for calculating the expected length of a {}-Game set under SRa Rules with Can't Win More Than {}:".format(2*enoughtowin-1,cantwinmorethan))
