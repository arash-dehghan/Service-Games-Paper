    ...
    while keeprunning == True:
        ...
        if total == 0:
            ...
            for i in bwinslist:
                mylist.append(i)
            print(mylist)
            TRaExpEquation(enoughtowin)
        else:
            TRaExpList(enoughtowin)

def TRaExpEquation(enoughtowin):
    global mylist
    equation = ''
    for i in mylist:
    ...
    print("Here is the simplified equation for calculating the expected length of a {}-Game set under TRa Rules:".format(2*enoughtowin-1))
